...
<head>
    ...
    <title>Perfil</title>
    <link rel="stylesheet" href="Styles/cliente_privacidade.css">
     <!-- <script src="https://code.jquery.com/jquery-3.6.1.min.js" integrity="sha256-o88AwQnZB+VDvE9tvIXrMQaPlFFSUTR+nldQm1LuPXQ=" crossorigin="anonymous"></script>  -->
    <link rel="shortcut icon" href="imagens/favicon.ico" />
</head>
<body>
    <?php
        include 'Classes_paginas/cliente_privacidade_class.php';
    ?>
    <header>
        ...
        <div class="container_main">
            ...
            <div class="container_informacoes">
                <div class="container_usuario container_interno_informacoes">
                    <label>Nome de usuário: <span class="informacao"><?php echo $_SESSION["usuario"];?></span></label>
                    <p>*Gostaria de Alterar seu nome de usuário?</p>
                ...
                <div class="container_telefone container_interno_informacoes">
                    ...
                    <p>*Gostaria de Alterar seu número de telefone?</p>
                    <div class="inputs_container_interno_informacoes">
    ...
    <script src="Scripts/cliente_privacidade.js"></script>
</body>
</html>