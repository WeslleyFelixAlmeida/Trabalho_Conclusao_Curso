...
<head>
    ...
    <link rel="stylesheet" href="Styles/cervejas.css">
    <link rel="shortcut icon" href="imagens/favicon.ico" />
</head>
<body>    
    <?php        
        include 'Classes_paginas/cervejas_class.php';
    ?>
    <header>
        <div class="container_header">
            ...
            <div class="header_direita">
                    <div class="container_login" <?php echo $Cervejas->login?>>
                    ...
                    <div class="container_perfil" <?php echo $Cervejas->perfil?>>
                        <a href="<?php echo $Cervejas->URL_perfil;?>">
        ...
        <section class="lateral-esquerda" id="lateral-esquerda">
            <div class="container-filtro">
                ...
                <div class="tipos_produto">
                    <h1>Filtre pelos tipos de Cervejas:</h1>
                    <div>
    ...
    <script src="Scripts/cervejas.js"></script>
</body>
</html>