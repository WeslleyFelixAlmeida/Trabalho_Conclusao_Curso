...
<head>
    ...
    <link rel="stylesheet" href="Styles/espumantes.css">
    <link rel="shortcut icon" href="imagens/favicon.ico" />
</head>
<body> 
    <?php        
        include 'Classes_paginas/espumantes_class.php';
    ?>  
    <header>
        <div class="container_header">
            ...
            <div class="header_direita">
                    <div class="container_login" <?php echo $Espumantes->login?>>
                    ...
                    <div class="container_perfil" <?php echo $Espumantes->perfil?>>
                        <a href="<?php echo $Espumantes->URL_perfil;?>">
        ...
        <section class="lateral-esquerda" id="lateral-esquerda">
            <div class="container-filtro">
                ...
                <div class="tipos_produto">
                    <h1>Filtre pelos tipos de Espumantes:</h1>
                    <div>
    ...
    <script src="Scripts/espumantes.js"></script>
</body>
</html>