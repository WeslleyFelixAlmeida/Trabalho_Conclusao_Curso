...
<head>
    ...
    <title>Uísques</title>
    <link rel="stylesheet" href="Styles/uisques.css">
    <link rel="shortcut icon" href="imagens/favicon.ico" />
</head>
<body> 
    <?php
        include 'Classes_paginas/uisques_class.php';
    ?>
<header>
        <div class="container_header">
            ...
            <div class="header_direita">
                    <div class="container_login" <?php echo $Uisques->login?>>
                    ...
                    <div class="container_perfil" <?php echo $Uisques->perfil?>>
                        <a href="<?php echo $Uisques->URL_perfil;?>">
    ...
    <script src="Scripts/uisques.js"></script>
</body>
</html>